export const ilIlce = {
  ...
  "Tekirdağ"       : ['Çerkezköy', 'Çorlu', 'Hayrabolu', 'Malkara', 'Marmara Ereğlisi', 'Muratlı', 'Saray', 'Şarköy', 'Tekirdağ'],
  ...
  "Tunceli"        : ['Çemişgezek', 'Hozat', 'Mazgirt', 'Nazimiye', 'Ovacık', 'Pertek', 'Pülümür', 'Tunceli'],
